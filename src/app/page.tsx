  ...
  return (
    <>
      ...
      <div className="p-0 m-0 bg-[#C5C5C54D]">
        <div className="flex flex-col-reverse lg:flex-row max-w-screen-2xl mx-auto xl:p-14 lg:gap-[50px]">
          <div className="w-full lg:w-1/2 flex flex-col justify-center">
            ...
            />
            <Spacer height="h-[10px] md:h-[15px]" />
            <Paragraph
              color="#4D5053"
            ...
            />
            <Spacer height="h-[20px] md:h-[25px] xl:h-[35px]" />
            <Button text="Explore More" href="/about" withArrow={true} />
          </div>
