      ...
      />
       <section className="bg-cover bg-center md:flex items-end justify-center bg-white">
        <div className="text-white text-center max-w-screen-2xl mx-auto py-[40px]  px-[10px] 2xl:px-14 w-full h-full ">
          <Heading1 text={`Contact Us`} color="#000" />
          <Spacer height="h-[15px] md:h-[15px]" />
          <Paragraph
            color="#000"
            text="At Kode Tec, we value your inquiries and feedback. Whether you have a project in mind,"
          />
          <Paragraph
            color="#000"
            text="question about our services, or simply want to explore collaboration opportunities, we're here for you."
          />
